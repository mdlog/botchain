    ...
    <div className="px-6 pb-8 w-full">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="grid grid-cols-2 gap-3">
            <div className="rounded-xl bg-surface-container-high p-3">
              <div className="mb-2 flex items-center gap-1.5">
                <Server className="h-3.5 w-3.5 text-compute-active" />
                <span className="font-mono text-[9px] font-semibold uppercase text-outline">Active</span>
              </div>
            ...
            <div className="rounded-xl bg-surface-container-high p-3">
              <div className="mb-2 flex items-center gap-1.5">
                <Zap className="h-3.5 w-3.5 text-compute-idle" />
                <span className="font-mono text-[9px] font-semibold uppercase text-outline">Jobs</span>
              </div>
              <span className="font-mono text-lg font-bold text-on-surface">
                {totalJobs.toString()}
              </span>
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-xs font-semibold text-on-surface">Earnings & Volume</h3>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="rounded-xl bg-surface-container-low p-3">
                <div className="mb-1 flex items-center justify-between">
                  <span className="flex items-center gap-1.5 font-mono text-[10px] font-semibold uppercase tracking-wider text-on-surface">
                    <DollarSign className="h-3 w-3 text-compute-active" /> Your Revenue
                  </span>
                </div>
                <span className="font-mono text-base font-bold text-compute-active">
              ...
              <div className="rounded-xl bg-surface-container-low p-3">
                <div className="mb-1 flex items-center justify-between">
                  <span className="flex items-center gap-1.5 font-mono text-[10px] font-semibold uppercase tracking-wider text-on-surface">
                    <TrendingUp className="h-3 w-3 text-primary" /> Network Volume
                  </span>
                </div>
                <span className="font-mono text-base font-bold text-primary">
                  {formatBOTCompact(totalVolume)}
                </span>
                <span className="ml-1 font-mono text-[10px] text-outline">DGRAM</span>
              </div>
              ...
              <div className="rounded-xl bg-surface-container-low p-3">
                <div className="mb-1 flex items-center justify-between">
                  <span className="flex items-center gap-1.5 font-mono text-[10px] font-semibold uppercase tracking-wider text-on-surface">
                    <CheckCircle2 className="h-3 w-3 text-compute-active" /> Completed
                  </span>
                  <span className="font-mono text-[10px] text-outline">
                    of {totalJobs.toString()} total
                  </span>
                </div>
